...
El campo es nativo y compatible con las herramientas de dictado o escaneo de
texto que ofrezca el teclado del dispositivo. No incluye OCR propio, cámara,
backend, dependencias ni una segunda página.
